...
Este documento contiene las instrucciones y flujos de trabajo recomendados para trabajar en este repositorio, especialmente para resolver el objetivo de hacer pasar los tests de FFmpeg en Linux sin eliminar *flags* de compilación.
