...
build_android() {
    ...
    ./configure \
        ...
        ${neon_flag:+$neon_flag} \
        $arch_extra_flags \
        $feature_flags || { tail -n 100 ffbuild/config.log; exit 1; }
